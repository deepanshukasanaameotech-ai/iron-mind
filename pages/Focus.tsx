...
import SoundSanctuary from './SoundSanctuary';
    ...
    <div className="space-y-12">
      <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8">
        ...
        <div className="relative w-80 h-80 flex items-center justify-center border-4 border-neutral-800 rounded-full bg-neutral-950">
          <div className={`absolute inset-0 rounded-full border-4 border-emerald-500 opacity-20 ${isActive ? 'animate-pulse' : ''}`}></div>
